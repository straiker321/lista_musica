   ...
   <div class="container" style="padding: 20px 0px 20px 0px">
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <font class="texto" color="white">Imagen</font>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                                <li>
                                    <a class="dropdown-item" href="<c:url value='/imagen_registrar'/>">
	...
	<table>
		...
		<c:forEach var="imagen" items="${bImagen}">
			<tr>
				<td><font class="texto" color="white">${imagen.imagenId}</font></td>
				<td><font class="texto" color="white">${imagen.nombre}</font></td>				
				<td>				
				...
				<td>
					<a href="<c:url value="/imagen_editar/${imagen.imagenId}"/>"><font class="texto" color="white">Editar</font></a>
					<a href="<c:url value="/imagen_borrar/${imagen.imagenId}"/>"><font class="texto" color="white">Borrar</font></a>
				</td>
			</tr>
		</c:forEach>
	</table>
